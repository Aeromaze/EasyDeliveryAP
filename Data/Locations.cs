...
public class Locations
{
    ...
    public class FishingTown
    {
        ...
        public static NodeData Nodedock31 = new("", "Smalton", 6);
        public static NodeData Node58 = new("", "Damton", 7);
        public static NodeData Node91 = new("", "Clifton", 8);
        public static NodeData Node54 = new("", "Damton", 9);
        public static NodeData Node18 = new("", "Damton", 10);
        public static NodeData Node64 = new("", "Damton", 11);
        public static NodeData Node97 = new("", "Clifton", 12);
        public static NodeData Node20 = new("", "Damton", 13);
        public static NodeData Node22 = new("", "Damton", 14);
        public static NodeData Node89 = new("", "Clifton", 15);
        public static NodeData Node55 = new("", "Damton", 16);
        public static NodeData Node112 = new("", "Damton", 17);
        public static NodeData Node12 = new("", "Damton", 18);
        public static NodeData Nodedock3 = new("", "Smalton", 19);
        public static NodeData Nodedock1 = new("", "Smalton", 20);
        public static NodeData Node14 = new("", "Smalton", 21);
        public static NodeData Nodedock21 = new("", "Smalton", 22);
        public static NodeData Node102 = new("", "Clifton", 23);
        public static NodeData Node98 = new("", "Clifton", 24);
        public static NodeData EasyFlowers = new("", "Smalton", 25);
        public static NodeData EasyEats = new("", "Smalton", 26);
        public static NodeData PawnShop = new("", "Clifton", 27);
        public static NodeData EZMart = new("", "Clifton", 28);
        public static NodeData Bar2 = new("", "Damton", 29);
        public static NodeData EasyDepot = new("", "Damton", 30);
        public static NodeData Bar1 = new("", "Clifton", 31);
        public static NodeData EZCafe = new("", "Damton", 32);
        public static NodeData EasyPizza = new("", "Smalton", 33);
        public static NodeData EZAuto = new("", "Clifton", 34);
        public static NodeData EZBakery = new("", "Damton", 35);
    }
